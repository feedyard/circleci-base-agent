...
(1/34) Installing readline (7.0.003-r1
(2/34) Installing bash (4.4.19-r1)
(3/34) Installing curl (7.64.0-r1)
(4/34) Installing libseccomp (2.3.3-r1)
(5/34) Installing runc (1.0.0_rc6-r1)
(6/34) Installing containerd (1.2.2-r0)
(7/34) Installing libmnl (1.0.4-r0)
(8/34) Installing jansson (2.11-r0)
(9/34) Installing libnftnl-libs (1.1.1-r0)
(10/34) Installing iptables (1.6.2-r1)
(11/34) Installing tini-static (0.18.0-r0)
(12/34) Installing device-mapper-libs (2.02.182-r0)
(13/34) Installing libltdl (2.4.6-r5)
(14/34) Installing docker (18.09.1-r0)
(15/34) Installing oniguruma (6.9.1-r0)
(16/34) Installing jq (1.6-r0)
(17/34) Installing openrc (0.39.2-r3)
(18/34) Installing docker-openrc (18.09.1-r0)
(19/34) Installing libbz2 (1.0.6-r6)
(20/34) Installing libffi (3.2.1-r6)
(21/34) Installing gdbm (1.13-r1)
(22/34) Installing xz-libs (5.2.4-r0)
(23/34) Installing sqlite-libs (3.26.0-r3)
(24/34) Installing python3 (3.6.8-r1)
(25/34) Installing gmp (6.1.2-r1)
(26/34) Installing yaml (0.2.1-r0)
(27/34) Installing ruby-libs (2.5.3-r1)
(28/34) Installing ruby (2.5.3-r1)
(29/34) Installing ruby-bigdecimal (2.5.3-r1)
(30/34) Installing ruby-etc (2.5.3-r1)
(31/34) Installing ruby-io-console (2.5.3-r1)
(32/34) Installing ruby-bundler (1.17.1-r0)
(33/34) Installing ruby-webrick (2.5.3-r1)
(34/34) Installing wget (1.20.1-r0)
